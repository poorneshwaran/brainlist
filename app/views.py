...
def brain_status(request):
	...
	if request.is_ajax() and request.POST:
		...
		sort_order = {'doi_a':0,'dop_a':0,'lu_a':0 , 'doi_d' : 1 , 'dop_d': 1 , 'lu_d':1}
	
	key_map = {'doi_d':'-dateofimg','dop_d':'-dateofperf','lu_d':'-lastupdate','doi_a':'dateofimg','dop_a':'dateofperf','lu_a':'lastupdate'}
	#print sort_order	
	for i in sort_order:
		if sort_order[i] == 1:
			orderby = key_map[i]	
